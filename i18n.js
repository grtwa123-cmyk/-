(() => {
  const translations = {
    en: {
      ...
      spawnBlackHoleHint: "Tap on the canvas to summon a black hole.",
      ...
      solarNotes: "Notes",
      solarNote1: "Orbital periods follow the real ratios (Kepler's third law T² ∝ a³). Radii use a √a compression so the inner planets are visible alongside Neptune.",
      solarNote2: "Once a black hole exists, every planet feels both the Sun's pull and the black hole's pull. Slow drifts become chaotic dives if the black hole sits inside the orbit.",
      solarNote3: "A planet that crosses the black hole's event horizon is consumed and produces a flash on the accretion disk.",
    },
    ko: {
      pageTitle: "과학 실험실",
      heroTitle: "과학 실험실",
      ...
      spawnBlackHoleHint: "캔버스를 누르면 그 자리에 블랙홀이 소환됩니다.",
      clearBlackHolesBtn: "블랙홀 모두 제거",
      resetSolarBtn: "궤도 초기화",
      propPlanetsRemaining: "남은 행성",
      propBlackHoles: "블랙홀",
      solarNotes: "설명",
      solarNote1: "공전 주기는 케플러 제3법칙(T² ∝ a³)을 따르는 실제 비율을 사용합니다. 거리는 √a 압축이라 내행성도 해왕성과 함께 보입니다.",
      solarNote2: "블랙홀이 생성되면 모든 행성은 태양과 블랙홀의 인력을 동시에 받습니다. 블랙홀이 궤도 안쪽에 있으면 안정적이던 운동이 격렬한 추락으로 바뀝니다.",
      solarNote3: "블랙홀의 사건의 지평선을 넘은 행성은 강착 원반에서 섬광을 남기며 사라집니다.",
    },
  };
