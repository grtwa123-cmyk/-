(() => {
  const translations = {
    ...
    ko: {
      ...
      diodeDesc: "순방향·역방향 바이어스를 전환할 때 공핍 영역이 어떻게 변하는지 관찰합니다.",
      ...
      diodeIntro: "순방향 바이어스에서는 전류가 흐르고, 역방향에서는 막힙니다. 가운데 공핍 영역이 그에 따라 좁아지거나 넓어집니다.",
      biasState: "바이어스 상태",
      biasForward: "순방향",
      biasZero: "0 바이어스",
      biasReverse: "역방향",
      ...
      builtInField: "내부 전기장",
      diodeNotes: "메모",
      diodeNoteForward: "순방향: 외부 전기장이 내부 전기장을 상쇄해 공핍 영역이 좁아지고 다수 캐리어가 접합을 넘어 전류가 흐릅니다.",
      diodeNoteReverse: "역방향: 외부 전기장이 내부 전기장과 같은 방향이라 공핍 영역이 넓어지고 거의 전류가 흐르지 않습니다.",
      diodeNoteZero: "바이어스 없음: 확산과 드리프트가 평형을 이루어 내부 전기장이 추가 확산을 막습니다.",
    },
  };
