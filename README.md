...
| --- | --- | --- |
| **Measured** | The mechanism runs and the textbook result is read back out of it. Nothing on the page types the answer in. | 25 |
| **Integrated** | The equations of motion are stepped forward in time. What you see is where they go. | 4 |
...
against its closed form on every commit — 26 of the 36 so far. It is not stored
